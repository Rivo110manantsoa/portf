...
<body>
    ...
    <header class="header">
        <section class="flex">
            ...
            <form  class="form-search">
                ...
                <button><a href="<?=ROOT?>home/blog" class="fa-solid fa-search"></a></button>
            </form>
            <div class="icons">
    ...
    <section class="sidebar">
        ...
        <nav class="navbar">
            ...
            <a class="<?=(isset($page) && $page == 'blog'  || $page == 'blog_details') ? 'active' : '';?>" href="<?=ROOT?>home/blog"><i class="fa-solid fa-chalkboard-user"></i><span>blog</span></a>
        </nav>
    </section>
    <!-- sidebar section end -->
    ...
    <!-- details section start -->
     <section class="details-container">
        ...
        <div class="box-container">
            <div class="box">
                <div class="large-box">
                    <img src="<?=ROOT?><?=$row->image?>" alt="" class="largeImage" id="largeImage">
                </div>
                <div class="small-box">
                    <img src="<?=ROOT?><?=$row->image?>" alt="" class="smallImage">
            ...
            <div class="box">
                <div class="flex-btn">
                    <a href="<?=ROOT?>home/blog" class="option-btn"><i class="fa-solid fa-arrow-circle-left"></i> back</a>
                    <a href="<?=ROOT?>home/details_blog/" class="option-btn"><i class="fa-solid fa-book"></i> read more</a>
                </div>
        ...
        <div class="box-container">
            ...
            <?php if(isset($_SESSION['error'])):?>
                ...
                <form action="" method="post">
                    ...
                    <input type="hidden" name="blogId" value="<?=$row->id?>" class="box-input">
                    <input type="text" maxlength="100" name="firstname" placeholder="Enter your firstname here" class="box-input">
                    <textarea name="comment" placeholder="Please enter your comment here" class="box-input"></textarea>
            ...
            <div class="box">
                ...
                <div class="box-flex">
                    <?php if(!empty($commblgs) && is_array($commblgs)):?>
                        <?php foreach($commblgs as $comm):?>
                            <div class="user">
                                <div class="flex-user-des">
                                    <img src="<?=ROOT?><?=$comm->image?>" alt="">
                                    <div>
                                        <h3><?=$comm->firstname?></h3>
                                        <div class="stars">
